          ...
          <blockquote className="relative">
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl font-medium italic text-gray-800 md:text-2xl md:leading-normal xl:text-3xl xl:leading-normal">
                Chez Izi Access, nous croyons fermement que le progrès est non
                seulement possible, mais nécessaire. Que ce soit à travers nos programmes
                d'entrepreneuriat, nos initiatives culturelles ou nos projets
                communautaires, nous nous engageons à créer un environnement
                propice à l'épanouissement et à la réussite de chacun.
              </p>
            </div>
