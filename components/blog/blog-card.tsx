...
const BlogCard = () => {
  return (
    ...
    <div className="flex gap-6 items-center">
      <a href="#" className="-ml-1 p-1 rounded-full flex items-center gap-3 hover:bg-gray-50">
        <img className="w-8 h-8 object-cover rounded-full" 
        src="https://tailus.io/sources/blocks/twocolumns/preview/images/man.jpg" alt=""/>
        <span className="hidden sm:block font-semibold text-base text-gray-600 ">Bernard Ng.</span>
      </a>
