...
const Services = () => {
  return (
    ...
    <div className="xl:container m-auto px-6 text-gray-500 md:px-12">
      ...
      <div
        className="mt-16 grid divide-x divide-y divide-gray-100 overflow-hidden rounded-3xl border border-gray-100 sm:grid-cols-2 lg:grid-cols-4 lg:divide-y-0 xl:grid-cols-4"
      >
