...
const Footer = () => {
  return (
    ...
    <footer>
    <div className="bg-gray-50 pt-8 md:pt-20">
        ...
        <div>
          ...
          <div>
            <div className="grid grid-cols-2 gap-6 pb-16 sm:grid-cols-3 md:grid-cols-5">
              ...
              <div>
                <h6 className="text-lg font-medium text-gray-700">Ressources</h6>
                <ul className="mt-4 list-inside space-y-4">
                  <li>
                    <a href="#" className="transition hover:text-primary">About</a>
                  </li>
              ...
              <div className="col-span-2 sm:col-span-3 md:col-span-2">
                <h6 className="text-lg font-medium text-gray-700">Contact</h6>
                <ul className="mt-4 list-inside space-y-4">
                  <li>
                  ...
                  <li>
                    <form action="">
                      <label htmlFor="newsletter" className="text-lg text-gray-700"
                      ...
                      <div className="relative mt-4">
                        <input
                          ...
                          className="invalid:outline-none placeholder-gray-600 rounded-3xl w-full bg-gray-100 px-4 py-3 ring-1 ring-gray-200 invalid:ring-red-400"
                        />
                        <button
                          type="submit"
                          title="Submit"
            ...
            <div className="flex justify-between border-t border-cyan-800 py-8 text-gray-200">
              <span>&copy; izi-access 2003 - <span id="year"></span></span>
